...
const Lost = () => {
 ...
 const generateSummary = () => {
  return `I've found a ${formData.color.toLowerCase()} ${formData.title.toLowerCase()}. It's currently safe at ${formData.location}. Cataloging for the campus grid...`;
};
      ...
      <AnimatePresence mode="wait">
        {step < questions.length ? (
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="glass-card text-center p-12 overflow-hidden relative">
            ...
            <p className="text-[#8FB3E2] font-bold italic mb-6">"Thank you for helping the campus community!""</p>
